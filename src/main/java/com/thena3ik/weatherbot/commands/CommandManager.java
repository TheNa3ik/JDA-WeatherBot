    ...
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        ...
        if (command.equals("ping")) {
            ...
            try {
                ...
                ImageGenerator img = new ImageGenerator(city);
                //img.saveImage();

                event.getHook().sendMessage("This is the weather in " + city + "!")
                        .addFiles(FileUpload.fromData(img.getAsFile())) // Attach image generated by ImageGenerator
    ...
    public void onButtonInteraction(ButtonInteractionEvent event) {
        ...
        if (event.getComponentId().equals("changeAppearance")) {
            ...
            try {
                ...
                event.editMessage(MessageEditData.fromFiles(FileUpload.fromData(img.getAsFile())))
                        .queue();
            } catch (IOException e) {
